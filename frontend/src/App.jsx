...
function App() {
  ...
  // Handle flow selection (from intake or manual selector)
  const handleFlowSelected = (flowId) => {
    actions.selectFlow(flowId)
  }
  
  // Handle showing manual flow selector
  ...
  const handleClearProgress = () => {
    if (window.confirm('Clear all progress for this flow? This cannot be undone.')) {
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex gap-2 print:hidden">
              ...
              <button
                ...
                className="bg-red-50 text-red-700 px-4 py-2 rounded hover:bg-red-100"
              >
                Clear Progress
              </button>
              <button
